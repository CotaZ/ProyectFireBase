...
public class MainActivity extends AppCompatActivity {
        ...
        btnbus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (txtid.getText().toString().trim().isEmpty()) {
                    Toast.makeText(MainActivity.this, "Dígite el ID del luchador a Buscar!", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    //DatabaseReference dbref = db.getReference().child("Luchador"); Cuando mi clase no es igual al nombre de la tabla de estructura de mi base de datos
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            for (DataSnapshot x : snapshot.getChildren()) {
                                if (x.child("nombre").getValue().toString().equalsIgnoreCase(nom)) {
                                    res2 = true;
                                    ocultarTeclado();
                                    Toast.makeText(MainActivity.this,"El nombre ("+nom+").\nImposible Modificar!", Toast.LENGTH_SHORT).show();
                                    break;
                                }
                            }
                            ...
                            if (res2 == false){
                                ...
                                for (DataSnapshot x : snapshot.getChildren()) {
                                    if (x.child("id").getValue().toString().equalsIgnoreCase(aux)) {
                                        ...
                                        a.setTitle("Pregunta");
                                        a.setMessage("¿Está Seguro(a) de querer Modificar el Registro?");
    ...
    private void botonEliminar() {
        btneli.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (txtid.getText().toString().trim().isEmpty()) {
                    Toast.makeText(MainActivity.this, "Dígite el ID del luchador a Eliminar!", Toast.LENGTH_SHORT).show();
                } else {
